...
async function verifyParticipant(email, dob) {
  return apiGet("verifyParticipant", { email, dob });
}
...
async function activateRound(qualifyCount, pin, nextRound) {
  const data = { qualifyCount, pin, nextRound };
